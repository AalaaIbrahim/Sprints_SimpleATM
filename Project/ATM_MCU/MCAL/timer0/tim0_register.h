...
/******************* Timer 0 ***********************/
#define	 TCNT0					  *((volatile Uchar8_t*)0x52)	
#define  TCCR0                    *((volatile Uchar8_t*)0x53)			/* Timer/Counter Control Register */
...
#define  OCR0                     *((volatile Uchar8_t*)0x5c)			/* Output compare register */

#define	 TIFR					  *((volatile Uchar8_t*)0x58)	
#define  TIFR_TOV0					0
